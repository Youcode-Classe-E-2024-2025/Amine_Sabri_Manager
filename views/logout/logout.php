...
<div class="bg-white shadow-lg rounded-lg w-full max-w-sm p-8">
    ...
    <form action="insert_user.php" method="POST" id="signupForm">
        ...
        <div class="mb-4">
            ...
            <input type="text" id="fullname" name="fullname" class="w-full p-3 mt-1 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" required>
        </div>
        <div class="mb-4">
