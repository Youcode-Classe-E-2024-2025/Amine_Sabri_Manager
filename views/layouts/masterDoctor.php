    ...
    >
      ...
      <aside class="z-20 hidden w-64 overflow-y-auto bg-white dark:bg-gray-800 md:block flex-shrink-0">
        <div class="py-4 text-gray-500 dark:text-gray-400">
          ...
          <ul>
            <li class="relative px-6 py-3">
              <a class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200" href="../doctor/form.php">
                <svg class="w-5 h-5" aria-hidden="true" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" stroke="currentColor">
                  <path d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01"></path>
                </svg>
                <span class="ml-4">Form de dossier</span>
              </a>
            </li>
            <li class="relative px-6 py-3">
              <a class="card-rendez-vous inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200">
                <svg class="w-5 h-5" aria-hidden="true" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" stroke="currentColor">
                  <path d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10"></path>
                </svg>
                <span class="ml-4">All Rendez-Vous</span>
              </a>
            </li>
            <li class="relative px-6 py-3 ">
              <a class="card_dossier_medical inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200" >
                <svg class="w-5 h-5" aria-hidden="true" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" stroke="currentColor">
                  <path d="M11 3.055A9.001 9.001 0 1020.945 13H11V3.055z"></path>
                  <path d="M20.488 9H15V3.512A9.025 9.025 0 0120.488 9z"></path>
                </svg>
                <span class="ml-4">All dossier Medical</span>
              </a>
            </li>
          </ul>
        </div>
              ...
              <li>
                <?php
                  if (isset($_SESSION['full_name'])) {
                    echo "<h1 class=\"border-2 border-purple-500 text-white rounded-lg p-[2px] pl-10 pr-10 bg-purple-500\">" . "Dr. " . $_SESSION['full_name'] . "</h1>";
                  ...
                  >
                    <li class="flex justify-center items-center w-fit">
                      <form action="" method="POST">
                          <button type="submit" name="logout" class=" text-gray-600 px-2 py-1 rounded hover:bg-gray-500"><i class="bi bi-box-arrow-right"></i>Logout</button>
                      </form>
                      </a>
                    </li>
                  </ul>
          ...
          <div class="container px-6 mx-auto grid">
            ...
            <div class="flex justify-around mb-8">
              ...
              >
                ...
                <div>
                    <p class="mb-2 text-sm font-medium text-gray-600 dark:text-gray-400">Rendez-vous</p>
                    <?php
                      include("../../db.php");
                      $sql = "SELECT count(*) FROM \"rendez_vous\"";
                      $count_rendez_vous = $pdo->query($sql)->fetchColumn();
                    ?>
                    <p class="text-lg font-semibold text-gray-700 dark:text-gray-200"><?php echo $count_rendez_vous; ?></p>
                </div>
              </div>
              <!-- Card -->
              <div
            ...
            <!-- New Table -->
             <section class="contentAll_rendez_vous">
                <?php 
                  include_once ("../doctor/contentAdmin.php");
                  echo $content
                ?>
             </section>
             <section class="contentAll_rendez_vousToDay hidden">
                <?php 
                  include_once ("../doctor/contentAdmin.php");
                  echo $content_today;
                ?>
